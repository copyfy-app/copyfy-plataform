  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <nav className="bg-zinc-900 border-b border-zinc-700">
        <div className="container mx-auto px-4 md:px-8 py-4 bg-gray-950">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col md:flex-row items-center gap-2">
                <span className="text-sm text-white truncate max-w-48">{user?.email}</span>
            ...
            <div className="flex flex-wrap items-center gap-4 md:gap-6 text-sm">
              <a href="/terms-of-use" className="text-yellow-500 hover:text-yellow-400 transition-colors font-medium">
                Termos de Uso
              </a>
              <a href="/privacy-policy" className="text-yellow-500 hover:text-yellow-400 transition-colors font-medium">
              ...
              <Dialog open={isContactOpen} onOpenChange={setIsContactOpen}>
                <DialogTrigger asChild>
                  <button className="text-yellow-500 hover:text-yellow-400 transition-colors font-medium">
                    Contato
                  </button>
                </DialogTrigger>
                <DialogContent className="bg-zinc-900 border-zinc-700 text-white w-[95vw] max-w-md mx-auto">
                  <DialogHeader>
                  ...
                  <form onSubmit={handleContactSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <Textarea 
                        ...
                        className="bg-black border-zinc-600 text-white min-h-24" 
                      />
                    </div>
                    <Button 
                      type="submit" 
