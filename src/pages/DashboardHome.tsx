...
const DashboardHome = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-zinc-900 to-black flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-yellow-900/10 via-yellow-800/5 to-transparent animate-pulse" />

      {/* Card central animado */}
      <div className="w-full max-w-xl bg-black/60 border border-yellow-600 shadow-2xl p-8 rounded-2xl text-white text-center space-y-6 animate-fade-in z-10">
