...
const DashboardHome = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-zinc-900 flex items-center justify-center px-4 relative">
      ...
      <div className="w-full max-w-xl bg-black/60 border border-yellow-600 shadow-2xl p-8 rounded-2xl text-white text-center space-y-6 backdrop-blur-sm">
        ...
        <button onClick={() => navigate("/painel")} className="bg-yellow-500 hover:bg-yellow-600 text-black w-full text-lg py-6 rounded-xl shadow-lg transition-all duration-300 transform hover:scale-105">
          Ir para o Gerador de Copys
        </button>

        <div className="space-y-3 pt-6">
          <button onClick={() => navigate("/terms-of-use")} className="w-full border border-yellow-500 text-yellow-400 hover:text-yellow-500 hover:bg-yellow-400/10 py-3 rounded-xl transition-all duration-300 text-xl"> Termos de Uso</button>

          <button onClick={() => navigate("/privacy-policy")} className="w-full border border-yellow-500 text-yellow-400 hover:text-yellow-500 hover:bg-yellow-400/10 py-3 rounded-xl transition-all duration-300">
